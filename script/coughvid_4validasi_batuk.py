# coughvid_validasi_batuk.py v2 (sr = 16000)
import os
import pandas as pd
...
def process_file(row):
    ...
    file_path = os.path.join("Dataset Cough Covid Segmented", label, filename)
...
if __name__ == "__main__":
    # Baca metadata
    metadata_path = "Dataset Cough Covid Segmented/metadata_segmented.csv"
